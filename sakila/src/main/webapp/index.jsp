...
<div class="container">
	<h1>INDEX</h1>
		<h3 >List <i class="fas fa-list"></i></h3>
			<o1>
				<li><a href="<%=request.getContextPath()%>/list/storeList.jsp" data-toggle="tooltip" title="점포의 직원이름과 주소">StoreList</a></li>
				<li><a href="<%=request.getContextPath()%>/list/staffList.jsp" data-toggle="tooltip" title="직원의 주소,이메일,비밀번호">StaffList</a></li>
			</o1>
	   ...
	   <h3>View <i class="fas fa-table"></i></h3>
		...
		<h3>Search<i class="fas fa-search"></i></h3>
			<o1>
				<li><a href="<%=request.getContextPath()%>/search/filmSearchForm.jsp">filmSearch</a></li>
				<li><a href="<%=request.getContextPath()%>/search/rentalSearchForm.jsp">rentalSearch</a></li>
			</o1>
</div>
</body>
</html>