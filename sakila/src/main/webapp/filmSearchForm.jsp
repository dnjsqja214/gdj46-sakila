...
<%
	FilmCategoryDao filmCategory = new FilmCategoryDao();
   	List<FilmCategory> list = filmCategory.selectCategoryList();  
   	FilmInStockDao filmDao = new FilmInStockDao();
   ...
   <form action="<%=request.getContextPath()%>/filmSearchAction.jsp" method="post">
      <table border="1">
         ...
         <tr>
         	<td>영화시간</td>
         	<td>
         		<div><input type = "radio" name = "length" value="" checked="checked">선택안함</div> <!-- 초기값 -->
         		<div><input type = "radio" name = "length" value="0">1시간 미만</div><!-- lenghth 0~60 -->
         		<div><input type = "radio" name = "length" value="1">1시간 이상</div><!-- lenghth 60~ -->
         	</td>
         </tr>
         <tr>
         	<td>제목 검색</td>
